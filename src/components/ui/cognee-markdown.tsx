...
/**
 * Citation Badge Component - Simple tooltip-based solution
 */
...
/**
 * Replace inline [CITATION:N] with dynamic hover cards using shadcn components
 */
